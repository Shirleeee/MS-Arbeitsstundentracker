...
class TimeManagementServiceTest {
    ...
    @Test
    void validateStartTime_ValidFormat_ReturnEmptyString() {
    ...
    @Test
    void validateStartTime_StartTimeEmpty_ReturnErrorMessageString() {
    ...
    @Test
    void validateStartTime_StartTimeInFuture_ReturnErrorMessageString() {
    ...
    @Test
    void validateEndTime_ValidFormat_ReturnEmptyString() {
        LocalDateTime testStartTime = LocalDateTime.of(2024, 11, 11, 8, 0, 0);
    ...
    @Test
    void validateEndTime_EndTimeEmpty_ReturnErrorMessageString() {
        LocalDateTime testStartTime = LocalDateTime.of(2024, 11, 11, 8, 0, 0);
    ...
    @Test
    void validateEndTime_EndTimeInFuture_ReturnErrorMessageString() {
        LocalDateTime testStartTime = LocalDateTime.of(2024, 11, 11, 8, 0, 0);
    ...
    @Test
    void validateEndTime_EndTimeEqualsStartTime_ReturnErrorMessageString() {
        LocalDateTime testStartTime = LocalDateTime.of(2024,11, 11, 8, 0, 0);
    ...
    @Test
    void validateEndTime_EndTimeBeforeStartTime_ReturnErrorMessageString() {
        LocalDateTime testStartTime = LocalDateTime.of(2024, 11, 11, 8, 0, 0);
    ...
    @Test
    void validateDuration_ValidFormat_ReturnEmptyString() {
    ...
    @Test
    void validateDuration_DurationEmpty_ReturnErrorMessageString() {
    ...
    @Test
    void validateDuration_DurationTooLong_ReturnErrorMessageString() {
